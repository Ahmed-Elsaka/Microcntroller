...
/* DIO_NUMBER_PINS_IN_PORT: represent number of pins per port */
#define DIO_NUMBER_PINS_IN_PORT               8

/* next definitions used to avoid magic numbers */
#define DIO_DDR_A                             0
#define DIO_DDR_B                             1
#define DIO_DDR_C                             2
#define DIO_DDR_D                             3
...
/**********************************************************/
/*  DIO_MAXPINNB   : describe maximum no of pins in MC    */
/*  DIO_MAXPORTNB : describe maximum no of pins in MC     */
/**********************************************************/
